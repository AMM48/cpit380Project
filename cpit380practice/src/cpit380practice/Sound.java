...
//  }
  ...
  public Sound generalizedSplice(double zone) {
        ...
        Sound s = new Sound(
                (this.getLength() + sound2.getLength()) + (int) (this.getSamplingRate() * (Math.ceil(zone))));
...
//  public Sound spreadThenSqueeze(String start) {
//       int x = Integer.valueOf(start.getText());
//        Sound target = new Sound(s.getLength() * x + s.getLength()/x);
//        SoundSample[] sampleArray = s.getSamples();
...
//            ii = 0;
//            for (int j = -start; j < start; j++) {
//                avg += (sampleArray[i].getValue() * weighted[ii]);
//                ii++;
//            }
//            avg /= 5;
//            sampleArray[i].setValue(avg);
